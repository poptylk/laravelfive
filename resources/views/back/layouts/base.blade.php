...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{ asset('assets/css/theme-default/libs/toastr/toastr.css') }}">
		<link type="text/css" rel="stylesheet" href="{{ asset('assets/css/theme-default/libs/dropzone/dropzone-theme.css') }}">
		<link type="text/css" rel="stylesheet" href="{{ asset('assets/css/theme-default/libs/bootstrap-switch/bootstrap-switch.min.css') }}">
		<link type="text/css" rel="stylesheet" href="{{ asset('assets/css/theme-default/libs/blueimp-file-upload/jquery.fileupload.css') }}">
	...
	<body class="menubar-hoverable header-fixed">
			...
			<div id="content">
				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li><a href="{{ asset('html/.html') }}">home</a></li>
		...
		<script src="{{ asset('assets/js/libs/bootstrap-switch/bootstrap-switch.min.js') }}"></script>
		<script src="{{ asset('assets/js/libs/ckfinder/ckfinder.js') }}"></script>
