                    ...
                    <ul class="header-nav header-nav-options">
                        ...
                        <li class="dropdown hidden-xs">
                            ...
                            <ul class="dropdown-menu animation-expand">
                                ...
                                <li><a href="{{ asset('html/pages/login.html') }}">View all messages <span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
                                <li><a href="{{ asset('html/pages/login.html') }}">Mark as read <span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
                    ...
                    <ul class="header-nav header-nav-profile">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu animation-dock">
                                <li><a href="{{ asset('html/pages/profile.html') }}">Config</a></li>
                                ...
                                <li><a href="{{ asset('html/pages/login.html') }}"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
                            </ul><!--end .dropdown-menu -->
                        </li><!--end .dropdown -->
            ...
            <div id="menubar" class="menubar-inverse ">
                ...
                <div class="menubar-scroll-panel">
                    ...
                    <ul id="main-menu" class="gui-controls">
                        ...
                        <!-- BEGIN DASHBOARD -->
                        <li>
                            <a href="{{ asset('html/dashboards/dashboard.html') }}" class="active">
                        ...
                        <li class="gui-folder">
                            ...
                            <!--start submenu -->
                            <ul>
                                <li><a href="{{ asset('html/mail/inbox.html') }}" ><span class="title">Inbox</span></a></li>
                                <li><a href="{{ asset('html/mail/compose.html') }}" ><span class="title">Compose</span></a></li>
                                <li><a href="{{ asset('html/mail/reply.html') }}" ><span class="title">Reply</span></a></li>
                                <li><a href="{{ asset('html/mail/message.html') }}" ><span class="title">View message</span></a></li>
                            </ul><!--end /submenu -->
                        </li><!--end /menu-li -->
                        <!-- END EMAIL -->
                        ...
                        <li class="gui-folder">
                            ...
                            <!--start submenu -->
                            <ul>
                                <li><a href="{{ asset('html/ui/colors.html') }}" ><span class="title">Colors</span></a></li>
                                <li><a href="{{ asset('html/ui/typography.html') }}" ><span class="title">Typography</span></a></li>
                                <li><a href="{{ asset('html/ui/cards.html') }}" ><span class="title">Cards</span></a></li>
                                <li><a href="{{ asset('html/ui/buttons.html') }}" ><span class="title">Buttons</span></a></li>
                                <li><a href="{{ asset('html/ui/lists.html') }}" ><span class="title">Lists</span></a></li>
                                <li><a href="{{ asset('html/ui/tabs.html') }}" ><span class="title">Tabs</span></a></li>
                                <li><a href="{{ asset('html/ui/accordions.html') }}" ><span class="title">Accordions</span></a></li>
                                <li><a href="{{ asset('html/ui/messages.html') }}" ><span class="title">Messages</span></a></li>
                                <li><a href="{{ asset('html/ui/offcanvas.html') }}" ><span class="title">Off-canvas</span></a></li>
                                <li><a href="{{ asset('html/ui/grid.html') }}" ><span class="title">Grid</span></a></li>
                                <li class="gui-folder">
                                    <a href="javascript:void(0);">
                                    ...
                                    <!--start submenu -->
                                    <ul>
                                        <li><a href="{{ asset('html/ui/icons/materialicons.html') }}" ><span class="title">Material Design Icons</span></a></li>
                                        <li><a href="{{ asset('html/ui/icons/fontawesome.html') }}" ><span class="title">Font Awesome</span></a></li>
                                        <li><a href="{{ asset('html/ui/icons/glyphicons.html') }}" ><span class="title">Glyphicons</span></a></li>
                                        <li><a href="{{ asset('html/ui/icons/skycons.html') }}" ><span class="title">Skycons</span></a></li>
                                    </ul><!--end /submenu -->
                                </li><!--end /menu-li -->
                            </ul><!--end /submenu -->
                        </li><!--end /menu-li -->
                        ...
                        <li class="gui-folder">
                            ...
                            <!--start submenu -->
                            <ul>
                                <li><a href="{{ asset('html/tables/static.html') }}" ><span class="title">Static Tables</span></a></li>
                                <li><a href="{{ asset('html/tables/dynamic.html') }}" ><span class="title">Dynamic Tables</span></a></li>
                                <li><a href="{{ asset('html/tables/responsive.html') }}" ><span class="title">Responsive Table</span></a></li>
                            </ul><!--end /submenu -->
                        </li><!--end /menu-li -->
                        <!-- END TABLES -->
                        ...
                        <li class="gui-folder">
                            ...
                            <!--start submenu -->
                            <ul>
                                <li><a href="{{ asset('html/forms/basic.html') }}" ><span class="title">Form basic</span></a></li>
                                <li><a href="{{ asset('html/forms/advanced.html') }}" ><span class="title">Form advanced</span></a></li>
                                <li><a href="{{ asset('html/forms/layouts.html') }}" ><span class="title">Form layouts</span></a></li>
                                <li><a href="{{ asset('html/forms/editors.html') }}" ><span class="title">Editors</span></a></li>
                                <li><a href="{{ asset('html/forms/validation.html') }}" ><span class="title">Form validation</span></a></li>
                                <li><a href="{{ asset('html/forms/wizard.html') }}" ><span class="title">Form wizard</span></a></li>
                            </ul><!--end /submenu -->
                        </li><!--end /menu-li -->
                        <!-- END FORMS -->
                        ...
                        <li class="gui-folder">
                            ...
                            <ul>
                                <li class="gui-folder">
                                    ...
                                    <!--start submenu -->
                                    <ul>
                                        <li><a href="{{ asset('html/pages/contacts/search.html') }}" ><span class="title">Search</span></a></li>
                                        <li><a href="{{ asset('html/pages/contacts/details.html') }}" ><span class="title">Contact card</span></a></li>
                                        <li><a href="{{ asset('html/pages/contacts/add.html') }}" ><span class="title">Insert contact</span></a></li>
                                    </ul><!--end /submenu -->
                                </li><!--end /menu-li -->
                                <li class="gui-folder">
                                    <a href="javascript:void(0);">
                                    ...
                                    <!--start submenu -->
                                    <ul>
                                        <li><a href="{{ asset('html/pages/search/results-text.html') }}" ><span class="title">Results - Text</span></a></li>
                                        <li><a href="{{ asset('html/pages/search/results-text-image.html') }}" ><span class="title">Results - Text and Image</span></a></li>
                                    </ul><!--end /submenu -->
                                </li><!--end /menu-li -->
                                <li class="gui-folder">
                                    <a href="javascript:void(0);">
                                    ...
                                    <!--start submenu -->
                                    <ul>
                                        <li><a href="{{ asset('html/pages/blog/masonry.html') }}" ><span class="title">Blog masonry</span></a></li>
                                        <li><a href="{{ asset('html/pages/blog/list.html') }}" ><span class="title">Blog list</span></a></li>
                                        <li><a href="{{ asset('html/pages/blog/post.html') }}" ><span class="title">Blog post</span></a></li>
                                    </ul><!--end /submenu -->
                                </li><!--end /menu-li -->
                                <li class="gui-folder">
                                    <a href="javascript:void(0);">
                                    ...
                                    <!--start submenu -->
                                    <ul>
                                        <li><a href="{{ asset('html/pages/404.html') }}" ><span class="title">404 page</span></a></li>
                                        <li><a href="{{ asset('html/pages/500.html') }}" ><span class="title">500 page</span></a></li>
                                    </ul><!--end /submenu -->
                                </li><!--end /menu-li -->
                                <li><a href="{{ asset('html/pages/profile.html') }}" ><span class="title">User profile<span class="badge style-accent">42</span></span></a></li>
                                <li><a href="{{ asset('html/pages/invoice.html') }}" ><span class="title">Invoice</span></a></li>
                                <li><a href="{{ asset('html/pages/calendar.html') }}" ><span class="title">Calendar</span></a></li>
                                <li><a href="{{ asset('html/pages/pricing.html') }}" ><span class="title">Pricing</span></a></li>
                                <li><a href="{{ asset('html/pages/timeline.html') }}" ><span class="title">Timeline</span></a></li>
                                <li><a href="{{ asset('html/pages/maps.html') }}" ><span class="title">Maps</span></a></li>
                                <li><a href="{{ asset('html/pages/locked.html') }}" ><span class="title">Lock screen</span></a></li>
                                <li><a href="{{ asset('html/pages/login.html') }}" ><span class="title">Login</span></a></li>
                                <li><a href="{{ asset('html/pages/blank.html') }}" ><span class="title">Blank page</span></a></li>
                            </ul><!--end /submenu -->
                        </li><!--end /menu-li -->
                        <!-- END FORMS -->
                        ...
                        <!-- BEGIN CHARTS -->
                        <li>
                            <a href="{{ asset('html/charts/charts.html') }}" >
                ...
                <div id="offcanvas-chat" class="offcanvas-pane style-default-light width-12">
                    ...
                    <div class="offcanvas-body">
                        <ul class="list-chats">
                            <li>
                                <div class="chat">
                                    <div class="chat-avatar"><img class="img-circle" src="{{ asset('assets/img/avatar1.jpg') }}?1403934956" alt="" /></div>
                                    <div class="chat-body">
                            ...
                            <li class="chat-left">
                                <div class="chat">
                                    <div class="chat-avatar"><img class="img-circle" src="{{ asset('assets/img/avatar9.jpg') }}?1404026744" alt="" /></div>
                                    <div class="chat-body">
